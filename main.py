...
app = FastAPI(
    ...
    version="1.0.0",
    description="Backend for Learn by Video platform using Firebase Auth (Google + Email/Password).",
)
...
# Routers
app.include_router(public_router)  # /auth/check, /auth/health
app.include_router(me_router)      # /me, /me/username
